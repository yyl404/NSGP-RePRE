_base_ = [
    ...
    f'../_base_/datasets/voc_10_10_task1_2007.py',
...
previous_dir = f'./work_dirs/ewpr_split_id/cl_faster_rcnn_ns3_split_id_10_10_{task_id-1}'
ckpt_keywords='best'
...
work_dir=f'./work_dirs/ewpr_split_id/cl_faster_rcnn_ns3_split_id_10_10_{task_id}'