_base_ = [
    ...
    f'../_base_/datasets/voc_15_5_task2_2007.py',
...
previous_dir = f'./work_dirs/ewpr_split_id/cl_faster_rcnn_ns3_split_id_15_5_{task_id-1}'
ckpt_keywords='best'
...
work_dir=f'./work_dirs/ewpr_split_id/cl_faster_rcnn_ns3_split_id_15_5_{task_id}'