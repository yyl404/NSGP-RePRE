_base_ = [
    ...
    f'../_base_/datasets/voc_19_1_task2_2007.py',
...
task_id = 2
train_task_split = [0, 19, 20]

offset = 0.0
ignore_keys = ["rpn", "roi_head"]
previous_dir = f'./work_dirs/ewpr_split_id/cl_faster_rcnn_ns3_split_id_19_1_{task_id-1}'
ckpt_keywords='best'
...
work_dir=f'./work_dirs/ewpr_split_id/cl_faster_rcnn_ns3_split_id_19_1_{task_id}'