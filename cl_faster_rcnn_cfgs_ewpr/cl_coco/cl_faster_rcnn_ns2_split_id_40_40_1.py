...
previous_dir = f'./work_dirs/coco_template/faster-rcnn_r50_fpn_1x_coco_40_40_base' + "none"
work_dir = f'./work_dirs/coco_template/faster-rcnn_r50_fpn_1x_coco_40_40_base'
load_from = work_dir + "/best_epoch_12_modified.pth"
resume=True
ns_thresh = 0.0
ns_init = False
rr_thresh = [0.5, 0.7]
